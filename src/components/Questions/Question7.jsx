...
import Question7Pic from "../../assets/pics/Question7Pic.png";
import ProgressBar7 from "../../assets/pics/ProgressBar7.png";
...
function Question7() {
  ...
  return (
    <div className="wrap question7">
      <div className="answer">
        <div className="top">
          <div className="questionPic">
            <img src={Question7Pic} alt="第一題的圖片" />
          </div>
        </div>
